...
public class CreateGameCommand extends SubCommand {
    ...
    public CreateGameCommand(WhoIsTheSpy whoIsTheSpy) {
        super(
                false,
                2,
                2,
                "create",
                WhoIsTheSpyCommand.PERMISSION_ADMINISTRATOR_PREFIX + "create",
                whoIsTheSpy
        );
    }
        ...
        try {
            if (Util.isValidFileName(args[1])) {
                if (Game.create(args[1])) {
                    WhoIsTheSpyLocale.SUCCESS_CREATE_GAME.message(
                    ...
                    WhoIsTheSpyLocale.ERROR_CREATE_GAME.message(
                            WhoIsTheSpyLocale.PREFIX,
                            sender,
                            "%GAME%",
                            args[1]

...
public class SetGameCountdownCommand extends SubCommand {
    ...
    public SetGameCountdownCommand(WhoIsTheSpy whoIsTheSpy) {
        super(
                false,
                3,
                3,
                "setCountdown",
                WhoIsTheSpyCommand.PERMISSION_ADMINISTRATOR_PREFIX + "setCountdown",
                whoIsTheSpy
        );
    }
        ...
        if (Util.verifyStringToInteger(args[2])) {
            if (Integer.parseInt(args[2]) > 0) {
                if (!game.isEnabled()) {
                    ...
                    WhoIsTheSpyLocale.SUCCESS_SET_GAME_COUNTDOWN.message(
                            WhoIsTheSpyLocale.PREFIX,
                            sender,
                            "%GAME%",
                            args[1],

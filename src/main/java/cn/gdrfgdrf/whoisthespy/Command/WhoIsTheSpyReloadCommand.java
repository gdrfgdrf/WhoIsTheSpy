...
public class WhoIsTheSpyReloadCommand extends SubCommand {
    public static final String SYNTAX = "/who reload";

    @Getter
    private final LocaleString description = WhoIsTheSpyLocale.COMMAND_RELOAD;

    public WhoIsTheSpyReloadCommand(WhoIsTheSpy whoIsTheSpy) {
        super(false, 1, 1, "reload", WhoIsTheSpyCommand.PERMISSION_ADMINISTRATOR_PREFIX + "reload", whoIsTheSpy);
    }
    ...
    public void onCommand(CommandSender sender, String[] args) {
        ...
        whoIsTheSpy.reload();
        WhoIsTheSpyLocale.SUCCESS_RELOAD.message(WhoIsTheSpyLocale.PREFIX, sender);
    }

...
public class WhoIsTheSpyAdminHelpCommand extends SubCommand {
    public static final String SYNTAX = "/who admin";

    @Getter
    private final LocaleString description = WhoIsTheSpyLocale.COMMAND_ADMIN;

    public WhoIsTheSpyAdminHelpCommand(WhoIsTheSpy whoIsTheSpy) {
        super(false, 1, 1, "admin", WhoIsTheSpyCommand.PERMISSION_ADMINISTRATOR_PREFIX + "help", whoIsTheSpy);
    }

...
public class SetGameDurationCommand extends SubCommand {
    ...
    public SetGameDurationCommand(WhoIsTheSpy whoIsTheSpy) {
        super(
                false,
                3,
                3,
                "setDuration",
                WhoIsTheSpyCommand.PERMISSION_ADMINISTRATOR_PREFIX + "setDuration",
                whoIsTheSpy
        );
    }
        ...
        if (Util.verifyStringToInteger(args[2])) {
            if (Integer.parseInt(args[2]) > 0) {
                if (!game.isEnabled()) {
                    ...
                    WhoIsTheSpyLocale.SUCCESS_SET_GAME_DURATION.message(
                            WhoIsTheSpyLocale.PREFIX,
                            sender,
                            "%GAME%",
                            args[1],

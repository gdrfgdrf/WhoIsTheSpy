...
public class SetGameVoteDurationCommand extends SubCommand {
    ...
    public SetGameVoteDurationCommand(WhoIsTheSpy whoIsTheSpy) {
        super(
                false,
                3,
                3,
                "setVoteDuration",
                WhoIsTheSpyCommand.PERMISSION_ADMINISTRATOR_PREFIX + "setVoteDuration",
                whoIsTheSpy
        );
    }
        ...
        if (Util.verifyStringToInteger(args[2])) {
            if (Integer.parseInt(args[2]) > 0) {
                if (!game.isEnabled()) {
                    ...
                    WhoIsTheSpyLocale.SUCCESS_SET_GAME_VOTE_DURATION.message(
                            WhoIsTheSpyLocale.PREFIX,
                            sender,
                            "%GAME%",
                            args[1],

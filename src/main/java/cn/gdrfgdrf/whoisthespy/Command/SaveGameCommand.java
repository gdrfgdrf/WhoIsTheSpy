...
public class SaveGameCommand extends SubCommand {
    ...
    static {
        SYNTAX = "/who save %START%%NAME%%END%"
                .replace("%START%",
    ...
    public SaveGameCommand(WhoIsTheSpy whoIsTheSpy) {
        super(
                false,
                2,
                2,
                "save",
                WhoIsTheSpyCommand.PERMISSION_ADMINISTRATOR_PREFIX + "save",
                whoIsTheSpy
        );
    }
    ...
    public void onCommand(CommandSender sender, String[] args) {
        ...
        try {
            ...
            WhoIsTheSpyLocale.SUCCESS_SAVE_GAME.message(
                    WhoIsTheSpyLocale.PREFIX,
                    sender,
                    "%GAME%",
                    args[1]
            ...
            e.printStackTrace();
            WhoIsTheSpyLocale.ERROR_SAVE_GAME.message(
                    WhoIsTheSpyLocale.PREFIX,
                    sender
            );
        }

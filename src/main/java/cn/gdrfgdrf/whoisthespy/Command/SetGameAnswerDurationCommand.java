...
public class SetGameAnswerDurationCommand extends SubCommand {
    ...
    public SetGameAnswerDurationCommand(WhoIsTheSpy whoIsTheSpy) {
        super(
                false,
                3,
                3,
                "setAnswerDuration",
                WhoIsTheSpyCommand.PERMISSION_ADMINISTRATOR_PREFIX + "setAnswerDuration",
                whoIsTheSpy
        );
    }
        ...
        if (Util.verifyStringToInteger(args[2])) {
            if (Integer.parseInt(args[2]) > 0) {
                if (!game.isEnabled()) {
                    ...
                    WhoIsTheSpyLocale.SUCCESS_SET_GAME_ANSWER_DURATION.message(
                            WhoIsTheSpyLocale.PREFIX,
                            sender,
                            "%GAME%",
                            args[1],
